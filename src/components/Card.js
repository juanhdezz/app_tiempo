                        ...
                        <div className="card mb-3 mx-auto  bg-dark text-light">
                            <div className="row g-0"> 
                                <div className="col-md-4"> 
                                    ...
                                    <h1 className="card-temp ">{(weather.main.temp - 270.15).toFixed(1)} ºC</h1>
                                ...
                                <div className="col-md-8">
                                    <div className="card-body text-start mt-2">
                                        <h5 className="card-text">Temperatura Máxima : {(weather.main.temp_max - 270.15).toFixed(1) }ºC</h5>
                                        <h5 className="card-text">Temperatura Mínima : {(weather.main.temp_min - 270.15).toFixed(1)}ºC</h5>
                                        <h5 className="card-text">Sensación térmica : {(weather.main.feels_like - 270.15).toFixed(1)}ºC</h5>
